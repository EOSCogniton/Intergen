...
q=2/3;%0.483 ; %pourquoi avoir mit cette valeur sortie du chapeau ? d'autant que 2/3 permet d'obtenir un temps correct au skidpad
...
shift_RPM = [fsolve(@Couple12,500)/k_p/K(1)/k_f, fsolve(@Couple23,1000)/k_p/K(2)/k_f, fsolve(@Couple34,1200)/k_p/K(3)/k_f, fsolve(@Couple45,1200)/k_p/K(4)/k_f, fsolve(@Couple56,1500)/k_p/K(5)/k_f ];
...
function [dC] = Couple12(W)
    global rmot cmot k_p k_f K
        rmot1 = W/k_p/K(1)/k_f;
        rmot2 = W/k_p/K(2)/k_f;
        dC = interp1(rmot,cmot,rmot1)/k_p/K(1)/k_f-interp1(rmot,cmot,rmot2)/k_p/K(2)/k_f;
end

function [dC] = Couple23(W)
    global rmot cmot k_p k_f K
        rmot1 = W/k_p/K(2)/k_f;
        rmot2 = W/k_p/K(3)/k_f;
        dC = interp1(rmot,cmot,rmot1)/k_p/K(2)/k_f-interp1(rmot,cmot,rmot2)/k_p/K(3)/k_f;
end

function [dC] = Couple34(W)
    global rmot cmot k_p k_f K
        rmot1 = W/k_p/K(3)/k_f;
        rmot2 = W/k_p/K(4)/k_f;
        dC = interp1(rmot,cmot,rmot1)/k_p/K(3)/k_f-interp1(rmot,cmot,rmot2)/k_p/K(4)/k_f;
end

function [dC] = Couple45(W)
    global rmot cmot k_p k_f K
        rmot1 = W/k_p/K(4)/k_f;
        rmot2 = W/k_p/K(5)/k_f;
        dC = interp1(rmot,cmot,rmot1)/k_p/K(4)/k_f-interp1(rmot,cmot,rmot2)/k_p/K(5)/k_f;
end

function [dC] = Couple56(W)
    global rmot cmot k_p k_f K
        rmot1 = W/k_p/K(5)/k_f;
        rmot2 = W/k_p/K(6)/k_f;
        dC = interp1(rmot,cmot,rmot1)/k_p/K(5)/k_f-interp1(rmot,cmot,rmot2)/k_p/K(6)/k_f;
end